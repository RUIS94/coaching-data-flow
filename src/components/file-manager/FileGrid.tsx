              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="h-8 w-8 p-0 bg-background/80 hover:bg-gray-100 !hover:text-foreground"
                ...
                <DropdownMenuContent align="end" className="w-48">
                  <DropdownMenuItem onClick={() => onItemShare(item.id)} className="hover:bg-gray-100 !hover:text-foreground">
                    <Share2 className="h-4 w-4 mr-2" />
                    Share
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => onItemDownload(item.id)} className="hover:bg-gray-100 !hover:text-foreground">
                    <Download className="h-4 w-4 mr-2" />
                    Download
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => onItemRename(item.id)} className="hover:bg-gray-100 !hover:text-foreground">
                    <Edit className="h-4 w-4 mr-2" />
                    Rename
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => onItemCopy(item.id)} className="hover:bg-gray-100 !hover:text-foreground">
                    <Copy className="h-4 w-4 mr-2" />
                    Copy to...
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => onManageAccess(item.id)} className="hover:bg-gray-100 !hover:text-foreground">
                  ...
                  <DropdownMenuItem 
                    ...
                    className="text-destructive hover:bg-gray-100 !hover:text-destructive"
                  >
              ...
              <div className="w-12 h-12 flex items-center justify-center">
                {item.type === 'folder' ? (
                  ...
                  <>
                    ...
                    {item.fileType === 'mp3' && <FileAudio className="w-10 h-10 text-purple-600" />}
                    {item.fileType === 'mp4' && <FileVideo className="w-10 h-10 text-orange-600" />}

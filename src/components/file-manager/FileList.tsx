              ...
              <Checkbox
                ...
                ref={(el) => {
                  if (el && el.querySelector('button')) {
                    ...
                    if (btn) {
                      (btn as HTMLButtonElement & { indeterminate?: boolean }).indeterminate =
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-8 w-8 p-0 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-gray-100 !hover:text-foreground"
                        onClick={(e) => e.stopPropagation()}
                      >
